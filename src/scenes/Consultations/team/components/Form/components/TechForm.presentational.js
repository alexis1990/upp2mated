		...
		<Col xs={12} md={8} lg={12} className="team">
			...
			<Row className="show-grid">
			    {fields.map((field, index) =>
					<Col xs={12} md={8} lg={12} key={index}>
						<Row className="show-grid line">
					      	<Col sm={4} md={3} lg={3}>
					      		<Field type="text" placeholder="Prénom nom créateur loggué" withoutLabel name={`techReducer[${index}].identity`} component={renderInput}>Libellé</Field>
					      	</Col>
					      	<Col sm={4} md={1} lg={3}>
					      		<Field type="text" placeholder="Poste" withoutLabel name={`techReducer[${index}].job`} component={renderInput}>Poste</Field>
					      	</Col>
					      	<Col sm={4} md={2} lg={2}>
					      		<Field componentClass="select" withoutLabel name={`techReducer[${index}].nature`} placeholder="nature" component={Select}>Nature</Field>
					      	</Col>
					      	<Col sm={4} md={3} lg={3}>
					      		<span>
						          <Field name={`techReducer[${index}].employed`} id='employed' component="input" type="checkbox"/>
						        </span>
					      		<span>
					      	...
					      	<Col sm={2} md={1} lg={1}>
					      		<Button type="button" className="removeField" onClick={() => removeTechField(index)}>-</Button>
					      	</Col>
					    </Row>
			    ...
			    <Col xs={12} md={8} lg={12}>
			      <Button type="button" className="addField" onClick={() => addTechField()}>+</Button>
			    </Col>
			</Row>
  		</Col>
  	)
