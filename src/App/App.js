...
import EditUser from '../scenes/Administration/components/Users/EditUser/'
  ...
  <div>
    ...
    <main>
      <Switch>
          ...
          <Route exact path="/administration/users/user/edit/:id" component={requireAuthentication(EditUser)} />
